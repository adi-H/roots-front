import { Box, Button, Dialog, FormControl, InputLabel, MenuItem, Paper, Select, TextField, Typography } from "@mui/material";
...
export const InquiryModal = (props: Props) => {
    ...
    const handleInquirySubmit = async () => {
        try {
            await InquiryService.send({ title, content, from: { id: currentUser.id } as User, to: { id: recipientId } as Recipient });
            props.onClose();
    ...
    return (
        ...
        >
            ...
            <Button onClick={handleInquirySubmit} className={styles.sendButton}>
                שלח פנייה
            </Button>
        </Dialog >
    )
